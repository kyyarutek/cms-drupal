    ...
    <div id="wrapper">
        ...
        <div class="container_12">
            ...
            <div class="grid_12">
                ...
                <a href="<?php print url('node/3'); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'bluemasters') . '/slajdy/slajd1.jpg'; ?>"></a>
                </div>
                <div class="slider-item-caption">Czy darmowa ochrona jest skuteczna?</div>
                </li>
                <!-- EOF: slider-item -->
                ...
                <li class="slider-item">
                <div class="slider-item-image">
                <a href="<?php print url('node/4'); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'bluemasters') . '/slajdy/slajd2.jpg'; ?>"></a>
                </div>
                <div class="slider-item-caption">Co robić, aby nie złapać szkodnika?</div>
                </li>
                <!-- EOF: slider-item -->
                ...
                <li class="slider-item">
                <div class="slider-item-image">
                <a href="<?php print url('node/1'); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'bluemasters') . '/slajdy/slajd3.jpg'; ?>"></a>
                </div>
                <div class="slider-item-caption">Niezależne testy oprogramowania zabezpieczającego</div>
                </li>
                <!-- EOF: slider-item -->
